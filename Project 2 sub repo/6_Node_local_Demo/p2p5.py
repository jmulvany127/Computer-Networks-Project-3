...
filepath = "C:\\Users\\jsmul\\Desktop\\College Year 3\\Semester 2\\3D3 Computer Networks\\Project 2\\project 2 repo\\Final v3\\6 p2p local demo\\DATABASE5.txt"
filesize = os.path.getsize(filepath)


my_p_num = '5'     #peer number of this device
